"""Utilities for running functions in automated mode.

When ``INTERACTIVE_MODE=auto`` is set, these helpers provide
deterministic inputs and confirmations so functions can run without manual
...
def is_auto_mode() -> bool:
    """Return True when functions should bypass interactive prompts."""
    return os.environ.get("INTERACTIVE_MODE", "").lower() == "auto"
